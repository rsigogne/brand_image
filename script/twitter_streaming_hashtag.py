...
# iterator = twitter_stream.statuses.filter(track=["Renault", "renault"], language="fr")
iterator = twitter.search.tweets(q=["#renault", "#clio", "#megane",
                                    "#captur", "#kadjar", "#talisman",
                                    "#twingo", "#kangoo", "#espace",
                                    "#zoe", "#scenic"], result_type='recent', lang='fr', count=100000)
